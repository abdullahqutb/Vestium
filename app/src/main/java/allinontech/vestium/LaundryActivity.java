...
public class LaundryActivity extends AppCompatActivity {
    ...
    private allinontech.vestium.backend.Laundry laundry;
    private Wardrobe wardrobe;
    private Button addLaundry;

    public static LaundryActivity.MyAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        laundry = HomeScreen.laundry;
        //test = (LinearLayout) findViewById( R.id.noItem);

        adview = findViewById( R.id.laundryAdView);
        AdRequest adRequest = new AdRequest.Builder().build();
        adview.loadAd(adRequest);

        addLaundry = findViewById( R.id.additembutton);
        addLaundry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LaundryActivity.this, addLaundry.class);
        ...
        */
        ...
        categoryHolder.addItemDecoration(new LaundryActivity.GridSpacingItemDecoration(spanCount, spacing, includeEdge));
        adapter = new LaundryActivity.MyAdapter( LaundryActivity.this, laundry);
    ...
    public class MyAdapter extends RecyclerView.Adapter<LaundryActivity.ItemViewHolder> {
        Context c;
        allinontech.vestium.backend.Laundry items;

        public MyAdapter(Context c, allinontech.vestium.backend.Laundry laundry) {
            this.c = c;
            this.items = laundry;
        }

        @Override
        public LaundryActivity.ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v= LayoutInflater.from(c).inflate(R.layout.single_wardrobe_item, parent, false);
            return new LaundryActivity.ItemViewHolder(v);
        }

        @Override
        public void onBindViewHolder( final LaundryActivity.ItemViewHolder holder, int position) {
            ...
            holder.mView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder( LaundryActivity.this);
                    builder.setTitle( items.getData().get(index).getName());
                    builder.setItems(colors, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            laundry.getData().get( index).toggleLaundry( false);
                            HomeScreen.refreshData();
